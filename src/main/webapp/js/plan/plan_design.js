...
//	    	  console.dir(inst);
//	    	  $('#input_jh_startDate').datepicker('option', 'minDate',new
//	    	  Date(dateText.replace('-',',')));
//	      }
//	      onClose: function(selectedDate) {
//	    	  alert(selectedDate);
//	    	  _input_plan_design_startDate.datepicker( "option", "minDate", selectedDate );
//	      }
	});
	_input_plan_design_startDate.val(currdays);
//	$('#input_jh_startDate').datepicker('option', 'minDate', new Date(2014,0,1));
//	_input_plan_design_startDate.datetimepicker('setStartDate', currdays);
});
